...
const Task = () => {
  ...
  const taskCreateFn = async () => {
    const data = {
      ...
      image_url: "",
      shareId: databaseList?.app_info_list?.find((item: any) => item.type == 2)?.shareId || '',
      app_id: databaseList?.app_info_list?.find((item: any) => item.type == 2)?.app_id || '',
        ...
        {taskList.length > 0 && (
          ...
          >
            ...
            >
              ...
              >{`你有${taskList.length}个正在进行中的任务`}</div>
            </div>
            <div
              style={{
                marginTop: '15px',
            ...
            >
              ...
              <button
                ...
                onClick={() => {
                  ...
                  window.location.href = '/taskListPage';
                  // setNextIndex(0);
                }}
              >
                更多
